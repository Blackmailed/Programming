namespace Programming.Model.Geometry
{
    ...
    public class Point2D
    {
        ...
        /// <summary>
        /// Возвращает и задаёт координату Х. Также проверяет что координата положительна.
        /// </summary>
        public int X
        {
            get
        ...
        /// <summary>
        /// Возвращает и задаёт координату Y. Также проверяет что координата положительна.
        /// </summary>
        public int Y
        {
            get
